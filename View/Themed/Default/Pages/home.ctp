      ...
      // echo "<pre>";print_r($_SESSION);die();
        ...
        if($m==1)
        {
            echo "<script>
                ...
                toastr.success('Thank you for your inquiry, we will respond you in 24 hrs. Cheers!');
        </script>";
        }
        elseif($m==2)
        {
            echo "<script>
                ...
                toastr.warning('Error sending email. Please try again!!');
        </script>";
        }
        else
        {
        ...
        <div class="container">
            <div class="row">
               ...
               <div class="col-md-3 col-sm-3">
                    <div class="form-group">
                        <div class="input-group date checkinDate" data-date-format="yyyy-mm-dd">
              ...
              <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="form-group">
                        <div class="input-group date checkoutDate" data-date-format="yyyy-mm-dd">
...
<div class="content">
  ...
  <div class="section gallery">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="<?php echo $this->webroot;?>galleries"><div class="view-more"><button>View More</button></div></a>
        </div>
      </div>
    </div><!--/container -->
  </div><!--/gallery -->
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <li>
                        ...
                        <div class="input-group date" id="reservCheckIn" data-date-format="yyyy-mm-dd">
                    ...
                    <div class="col-md-6">
                      <li>
                        ...
                        <div class="input-group date" id="reservCheckOut" data-date-format="yyyy-mm-dd">
...
<script type="text/javascript">
  $(function()
    {
      $(".checkinDate").datepicker({startDate:"+0d", autoclose:true});

      $(".checkinDate").datepicker().on('changeDate', function(event){

        var today = new Date($("#checkin").val());
        // alert(today);
        var d = new Date(today.getFullYear(), today.getMonth(), today.getDate());
          $(".checkoutDate").datepicker('setStartDate',d);
      ...
      $(".checkoutDate").datepicker({autoclose:true});
